...
gulp.task('extras', function() {
  return gulp.src([
    'app/*.*',
    '!app/*.html',
    'node_modules/apache-server-configs/web/.htaccess'
  ], {
    dot: true
  }).pipe(gulp.dest('web'));
});

gulp.task('clean', require('del').bind(null, ['.tmp', 'web']));
...
gulp.task('buildweb', ['jshint', 'html', 'images', 'fonts', 'extras'],
  function() {
  return gulp.src('web/**/*').pipe($.size({title: 'build', gzip: true}));
});
